...
@section('content')
    ...
    <div class="row">
        <div class="col-4 offset-4">
            <form method="post" action="{{route("edades.update",$edade->id_edad)}}">
                @csrf
                @method("PUT")
                <div class="form-group">

                    <label for="descripcion"> Edad</label>
                    <input type="text" value="{{$edade->descripcion}}" id="descripcion" class="form-control" name="descripcion" placeholder="Edad">
